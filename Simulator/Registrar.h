...
class Registrar{
    ...
    std::map<std::string, function<unique_ptr<AbstractAlgorithm>()>> algorithmMap;
...
public:
    ...
    std::map<std::string, function<unique_ptr<AbstractAlgorithm>()>> getAlgorithmMap(){ return algorithmMap;}
};
